...
const Offers = ({ active, hotelId, setOfferId, adults }) => {
        ...
        return (
          ...
          >
            ...
            <ListItemText
              ...
              primary={<><span className={classes.offerText}>{headline}</span><span>adults:{offer.guests.adults}</span></>}
              secondary={
                <>
