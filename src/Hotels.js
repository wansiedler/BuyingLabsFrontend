...
const Hotels = ({cityCode, checkInDate, checkOutDate, setOfferId, adults}) => {
                                    ...
                                    <div className={classes.hotelGraphic}>
                                        {image ? (
                                            <img
                                                ...
                                                onError={(e) => {
                                                    e.target.src = 'https://www.keil.com/Content/images/photo_default.png' // some replacement image
